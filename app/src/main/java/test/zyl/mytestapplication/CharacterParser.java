...
/**
 * Created by zhangyl on 2016/8/21.
 */
public class CharacterParser {
    ...
    public String convert(String str) {
        ...
        if (str.equals("行")) {
            result = "hang";
        } else if (str.equals("亳")) {
            result = "bo";
        } else if (str.equals("嵊")) {
            result = "sheng";
        } else if (str.equals("泗")) {
            result = "si";
        } else if (str.equals("岢")) {
            result = "ke";
        } else if (str.equals("岚")) {
            result = "lan";
        } else if (str.equals("盱")) {
            result = "xu";
        } else if (str.equals("眙")) {
            result = "yi";
        } else if (str.equals("枸")) {
            result = "gou";
        } else if (str.equals("杞")) {
            result = "qi";
        } else if (str.equals("邛")) {
            result = "qiong";
        } else if (str.equals("崃")) {
            result = "lai";
        } else if (str.equals("滕")) {
            result = "teng";
        } else if (str.equals("邳")) {
            result = "pi";
        } else if (str.equals("兖")) {
            result = "yan";
        } else if (str.equals("涠")) {
            result = "wei";
        } else if (str.equals("涿")) {
            result = "zhuo";
        } else if (str.equals("泸")) {
            result = "lu";
        } else if (str.equals("儋")) {
            result = "dan";
        } else if (str.equals("衢")) {
            result = "qu";
        } else if (str.equals("湟")) {
            result = "huang";
        } else if (str.equals("阆")) {
            result = "lang";
        } else if (str.equals("缙")) {
            result = "jin";
        } else if (str.equals("婺")) {
            result = "wu";
        } else if (str.equals("涞")) {
            result = "lai";
        } else if (str.equals("荥")) {
            result = "xing";
        } else if (str.equals("沭")) {
            result = "shu";
        } else if (str.equals("溧")) {
            result = "li";
        } else if (str.equals("鄱")) {
            result = "po";
        } else if (str.equals("耒")) {
            result = "lei";
        } else if (str.equals("濮")) {
            result = "pu";
        } else if (str.equals("泸")) {
            result = "lu";
        } else if (str.equals("楠")) {
            result = "nan";
        } else if (str.equals("攸")) {
            result = "you";
        } else if (str.equals("绛")) {
            result = "jiang";
        } else if (str.equals("泾")) {
            result = "jing";
        }else if (str.equals("睢")) {
            result = "sui";
        }else if (str.equals("莒")) {
            result = "ju";
        }else if (str.equals("郏")) {
            result = "jia";
        }else if (str.equals("嵩")) {
            result = "song";
        }else if (str.equals("隰")) {
            result = "xi";
        }else if (str.equals("莘")) {
            result = "shen";
        }else if (str.equals("黟")) {
            result = "yi";
        }else if (str.equals("淇")) {
            result = "qi";
        }else if (str.equals("郫")) {
            result = "pi";
        }else if (str.equals("澧")) {
            result = "li";
        }else if (str.equals("蠡")) {
            result = "li";
        }else if (str.equals("柞")) {
            result = "zha";
        }else if (str.equals("浠")) {
            result = "xi";
        }else if (str.equals("偃")) {
            result = "yan";
        }//还有很多非常用的字需要识别,这里准备用同事推荐的pinyin4j.jar来处理,先暂停
        else {
     ...
     * @return
     */
    public String getFirstSell(String chs) {
        String sells = getSelling(chs);
        return sells.substring(0, 1).toUpperCase();
    }
     ...
     * @return
     */
    public String getFirstSells(String chs) {
        StringBuffer firstsells = new StringBuffer();
        for (int i = 0; i < chs.length(); i++) {
            char a = chs.charAt(i);
            String sell = getSelling(a + "");
            if (!sell.equals(""))
                firstsells.append(sell.substring(0, 1));
        }
        return firstsells.toString();
    }
