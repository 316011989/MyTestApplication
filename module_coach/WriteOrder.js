...
export default class WriteOrderActivity extends React.Component {
    ...
    render() {
        return (
            <View style={{ flex: 1, flexDirection: 'column', justifyContent: 'flex-start', backgroundColor: '#F6F6F6', }} >
                {/* 票面信息 */}
                <View style={{ margin: 10, backgroundColor: 'white', padding: 15, flexDirection: 'column', borderWidth: 0.5, borderRadius: 3, borderColor: '#DDDDDD', }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'flex-start', backgroundColor: 'white', marginBottom: 8, }}>
                ...
                <View style={{ flex: 1, flexDirection: 'column', justifyContent: 'flex-start', }}>
                    {/* 乘车人姓名手机号 */}
                    <View style={{ flexDirection: 'row', justifyContent: 'flex-start', backgroundColor: 'white', paddingLeft: 15, paddingTop: 10, paddingBottom: 10, borderColor: '#DDDDDD', borderTopWidth: 0.5, borderBottomWidth: 0.5 }}>
                    ...
                    {/* 乘车人身份证号 */}
                    <View style={{ flexDirection: 'row', justifyContent: 'flex-start', backgroundColor: 'white', paddingLeft: 15, borderColor: '#DDDDDD', borderBottomWidth: 0.5, paddingTop: 18, paddingBottom: 18 }}>
                        <View style={{ flex: 1 }}>
                    ...
                    {/* 费用归属 */}
                    <View style={{ flexDirection: 'row', justifyContent: 'flex-start', backgroundColor: 'white', paddingLeft: 15, borderColor: '#DDDDDD', borderTopWidth: 0.5, borderBottomWidth: 0.5, marginTop: 15, paddingTop: 18, paddingBottom: 18 }}>
                        <View style={{ flex: 1 }}>
                ...
                <View style={{ alignSelf: 'flex-end', flexDirection: 'row', justifyContent: 'flex-start', backgroundColor: 'white', paddingLeft: 15, paddingTop: 8, paddingBottom: 8 }}>
                    ...
                    <View style={{ flex: 2, backgroundColor: '#FF600A', borderRadius: 90, marginLeft: 10, marginRight: 10, paddingTop: 12, paddingBottom: 12 }}>
